/*
  ...
  INSTALL : add that script in your pages

  <script src="http://api.wx.mycompany.cn/script/wxSharing.js"></script>
  ...
  the window.wxSharing can be setuped later, after the script loading and changed dynamically
  on the pages, the script includes a watcher that will take the changes in account
*/
...
function getSignature (originUrl, pathnameUrl) {
